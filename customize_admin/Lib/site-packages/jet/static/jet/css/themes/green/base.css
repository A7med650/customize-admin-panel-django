...
.select2-container--jet .clear-list, .select2-container--jet .dashboard-item-content ul:not(.inline), .dashboard-item-content .select2-container--jet ul:not(.inline), .select2-container--jet .dashboard-item-content ul.inline, .dashboard-item-content .select2-container--jet ul.inline {
  margin: 0;
  padding: 0;
  list-style: none;
}
...
.select2-container--jet.select2-container--disabled .select2-selection--single {
  background-color: rgba(204, 234, 228, 0.25);
  cursor: default;
}
...
@media only screen and (max-width: 960px) {
  fieldset.module .select2-container--jet .select2-selection {
    -webkit-box-shadow: inset 0 2px 6px 0 rgba(0, 0, 0, 0.04);
...
.select2-container--jet .select2-dropdown {
  border: 0;
  border-radius: 4px;
  -webkit-box-shadow: 0 0 4px 0 rgba(68, 183, 139, 0.75);
...
input[type="text"]::-webkit-input-placeholder, input[type="email"]::-webkit-input-placeholder, input[type="password"]::-webkit-input-placeholder, input[type="url"]::-webkit-input-placeholder, input[type="number"]::-webkit-input-placeholder, textarea::-webkit-input-placeholder, select::-webkit-input-placeholder, .vTextField::-webkit-input-placeholder {
  color: #cceae4;
}

input[type="text"]:-ms-input-placeholder, input[type="email"]:-ms-input-placeholder, input[type="password"]:-ms-input-placeholder, input[type="url"]:-ms-input-placeholder, input[type="number"]:-ms-input-placeholder, textarea:-ms-input-placeholder, select:-ms-input-placeholder, .vTextField:-ms-input-placeholder {
  color: #cceae4;
}
...
table {
  ...
  border-radius: 4px;
  overflow-x: auto;
  -webkit-box-shadow: 0 2px 0 0 #cceae4;
...
.user-tools-theme-link.selected {
  -webkit-box-shadow: 0 0 1px 1px #e5e2a5;
...
.inline-related h3 {
  margin: 0;
  background: -webkit-gradient(linear, left bottom, left top, from(#fff), to(#f5fdfa));
...
.inline-navigation-top {
  ...
  left: 0;
  height: 40px;
  background: -webkit-gradient(linear, left top, left bottom, color-stop(25%, #fff), to(rgba(245, 253, 250, 0)));
  background: linear-gradient(to bottom, #fff 25%, rgba(245, 253, 250, 0) 100%);
  z-index: 1;
}
...
.inline-navigation-bottom {
  ...
  left: 0;
  height: 40px;
  background: -webkit-gradient(linear, left bottom, left top, color-stop(25%, #fff), to(rgba(245, 253, 250, 0)));
  background: linear-gradient(to top, #fff 25%, rgba(245, 253, 250, 0) 100%);
  z-index: 1;
}
...
.changeform-tabs-item a, .changeform-tabs-item a:hover, .changeform-tabs-item a:visited {
  ...
  font-size: 11px;
  text-transform: uppercase;
  -webkit-transition: background-color 0.1s, color 0.1s, border-color 0.3s;
