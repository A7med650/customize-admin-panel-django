...
.select2-container--jet .select2-dropdown {
  border: 0;
  border-radius: 4px;
  -webkit-box-shadow: 0 0 4px 0 rgba(71, 186, 193, 0.75);
...
table {
  ...
  border-radius: 4px;
  overflow-x: auto;
  -webkit-box-shadow: 0 2px 0 0 #d0dbe6;
...
.inline-related h3 {
  margin: 0;
  background: -webkit-gradient(linear, left bottom, left top, from(#fff), to(#f6fafc));
...
.inline-navigation-top {
  ...
  left: 0;
  height: 40px;
  background: -webkit-gradient(linear, left top, left bottom, color-stop(25%, #fff), to(rgba(246, 250, 252, 0)));
  background: linear-gradient(to bottom, #fff 25%, rgba(246, 250, 252, 0) 100%);
  z-index: 1;
}
...
.inline-navigation-bottom {
  ...
  left: 0;
  height: 40px;
  background: -webkit-gradient(linear, left bottom, left top, color-stop(25%, #fff), to(rgba(246, 250, 252, 0)));
  background: linear-gradient(to top, #fff 25%, rgba(246, 250, 252, 0) 100%);
  z-index: 1;
}
