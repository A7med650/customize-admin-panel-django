...
.select2-container--jet.select2-container--disabled .select2-selection--single {
  background-color: rgba(227, 236, 242, 0.25);
  cursor: default;
}
...
.select2-container--jet .select2-dropdown {
  border: 0;
  border-radius: 4px;
  -webkit-box-shadow: 0 0 4px 0 rgba(47, 170, 96, 0.75);
...
table {
  ...
  border-radius: 4px;
  overflow-x: auto;
  -webkit-box-shadow: 0 2px 0 0 #D5E3EC;
...
.user-tools-theme-link.selected {
  -webkit-box-shadow: 0 0 1px 1px #EFEDC8;
...
.inline-related h3 {
  margin: 0;
  background: -webkit-gradient(linear, left bottom, left top, from(#fff), to(#F8FAFC));
...
.inline-navigation-top {
  ...
  left: 0;
  height: 40px;
  background: -webkit-gradient(linear, left top, left bottom, color-stop(25%, #fff), to(rgba(248, 250, 252, 0)));
...
.inline-navigation-bottom {
  ...
  left: 0;
  height: 40px;
  background: -webkit-gradient(linear, left bottom, left top, color-stop(25%, #fff), to(rgba(248, 250, 252, 0)));
