...
$sidebar-background-color: #009471;
$sidebar-contrast-background-color: #008A63;
$sidebar-contrast-text-color: #00AD7C;

$sidebar-arrow-color: #0E674D;
$sidebar-hover-arrow-color: #FDBB5E;

$sidebar-action-color: #6DC5A8;
$sidebar-hover-action-color: #FDBB5E;

$sidebar-title-action-color: #fff;
$sidebar-hover-title-action-item-color: #FDBB5E;

$sidebar-text-color: #6DC5A8;
$sidebar-icon-color: #49B692;
$sidebar-link-color: #B6E2D3;
$sidebar-hover-link-color: #fff;
$sidebar-hover-background-color: #01805c;
...
$content-contrast2-background-color: #2faa60; //table header
...
$tab-selected-border-color: #10e666;
...
$button-hover-background-color: #10e666;
