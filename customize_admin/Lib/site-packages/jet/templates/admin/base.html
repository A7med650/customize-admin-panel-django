...
<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="{% static 'jet/css/vendor.css' as url %}{{ url|jet_append_version }}" />
    <link rel="stylesheet" type="text/css"
        href="{% static 'jet/css/icons/style.css' as url %}{{ url|jet_append_version }}" />
    <link rel="stylesheet" type="text/css"
        href="{% static 'jet/css/themes/'|add:THEME|add:'/base.css' as url %}{{ url|jet_append_version }}"
        class="base-stylesheet" />
    <link rel="stylesheet" type="text/css"
        href="{% static 'jet/css/themes/'|add:THEME|add:'/select2.theme.css' as url %}{{ url|jet_append_version }}"
        class="select2-stylesheet" />
    <link rel="stylesheet" type="text/css"
        href="{% static 'jet/css/themes/'|add:THEME|add:'/jquery-ui.theme.css' as url %}{{ url|jet_append_version }}"
...
<body
    class="{% if request.COOKIES.sidebar_pinned != 'false' %}menu-pinned {% endif %}{% if is_popup %}popup {% endif %}{% block bodyclass %}{% endblock %}"
    ...
    <div id="container">
        ...
        <div class="changeform-navigation">
            ...
            <a {% if sibling.url %} href="{{ sibling.url }}" {% endif %}
                class="changeform-navigation-button segmented-button left{% if not sibling %} disabled{% endif %}"
                title="{{ sibling.label }}">
            ...
            <a {% if sibling.url %} href="{{ sibling.url }}" {% endif %}
                class="changeform-navigation-button segmented-button right{% if not sibling %} disabled{% endif %}"
                title="{{ sibling.label }}">
            ...
            <div class="sidebar-wrapper scrollable">
                ...
                <div class="sidebar-section">
                    <div class="sidebar-title">
                        <a {% if app.url %} href="{{ app.url }}" {% endif %} class="sidebar-title-link"
                    ...
                    {% if model.has_perms %}
                    <div>
                        <a {% if model.url %} href="{{ model.url }}" {% endif %} class="sidebar-link"
                ...
                <div class="sidebar-section">
                    ...
                    <div class="apps-list-pinned">
                        ...
                        <a {% if app.url %} href="{{ app.url }}" {% endif %}
                            class="sidebar-link popup-section-link app-item" data-app-label="{{ app.app_label }}"
                            data-popup-section-class="sidebar-popup-section-{{ app.app_label }}"
                            data-order="{{ forloop.counter }}" {% if app.url_blank %} target="_blank" {% endif %}>
                    ...
                    <div class="sidebar-title">
                        <span class="sidebar-right">
                            <a href="#" class="sidebar-right-plus bookmarks-add" title="{% trans "Add bookmark" %}"
                                {% if title %} data-title="{{ title }}" {% endif %}><span class="icon-add"></span></a>
                        </span>
                        {% trans 'bookmarks' %}
                    </div>
                ...
                <div class="sidebar-popup scrollable">
                    ...
                    <div class="sidebar-popup-section sidebar-popup-section-{{ app.app_label }}">
                        ...
                        <ul class="sidebar-popup-list">
                            {% if app.url %}
                            <li
                                class="sidebar-popup-list-item app-{{ app.app_label }}{{ app.current|yesno:" current," }}">
                                <a href="{{ app.url }}"
                                    class="sidebar-popup-list-item-link">{% trans 'Application page' %}</a>
                            </li>
                            {% endif %}
                            ...
                            {% if model.has_perms %}
                            <li
                                class="sidebar-popup-list-item{% if model.name %} model-{{ model.name }}{% endif %}{{ model.current|yesno:" current," }}">
                                <a {% if model.url %} href="{{ model.url }}" {% endif %}
                                    class="sidebar-popup-list-item-link" {% if model.url_blank %} target="_blank"
                                    {% endif %}>
                                    {{ model.label }}
                                </a>
                            </li>
